...
import { Home, LayoutGrid, Heart, CreditCard, X } from "lucide-react";
...
const navigationItems = [
  ...
  { label: "All Campaigns", href: "/campaigns", icon: Home },
  {
    label: "My Campaigns (Following)",
    href: "/dashboard/following-campaigns",
    icon: Heart,
  },
  { label: "Donation History", href: "/dashboard/donations", icon: CreditCard },
];

export default function DonorSidebar({ isOpen, onClose }: DonorSidebarProps) {
